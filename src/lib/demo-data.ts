...
export const featureModules = [
  {
    slug: "suara-warga",
    title: "Suara Warga",
    short: "WhatsApp text, voice note, photo, assisted input.",
  ...
  },
  {
    slug: "lumbung-data",
    title: "Lumbung Data",
    short: "Queue verifikasi, transcript, field extraction, audit trail.",
  ...
  },
  {
    slug: "agen-ai",
    title: "Agen AI",
    short: "Agent intake, kualitas, harga, pasar, stok, risiko, laporan.",
  ...
  },
  {
    slug: "gerai-pintar",
    title: "Gerai Pintar",
    short: "Sembako, pupuk, LPG, stok kritis, restock suggestion.",
  ...
  },
  {
    ...
    short: "Gudang, cold storage, pickup schedule, aging risk.",
  ...
  },
  {
    ...
    short: "Buyer directory, match reason, outreach script, approval.",
  ...
  },
  {
    ...
    short: "Permintaan pembiayaan, tujuan, risiko, approval committee.",
    waCommand: "ajukan pinjaman pupuk 1 juta",
    owner: "Bendahara, komite",
    status: "Simulasi Aman",
  },
  {
    slug: "peta-unggulan",
    title: "Peta Unggulan Desa",
    short: "Komoditas unggulan, aset desa, peluang olahan, risiko harga, aksi awal.",
  ...
  },
  {
    slug: "lapor-siap",
    title: "Lapor Siap",
    short: "Ringkasan, audit evidence, CSV export, SIMKOPDES readiness.",
...
export const aiAgents = [
  {
    name: "Agen Intake Warga",
    job: "Membaca WhatsApp, voice note, foto, dan assisted input.",
    checks: ["Intent warga", "Bahasa sederhana", "Data minimum"],
    output: "Draft catatan warga",
    status: "Aktif",
  },
  {
    name: "Agen Normalisasi Data",
    job: "Mengubah kira-kira, karung, kuintal, bak pickup, dan lokasi lokal menjadi field terstruktur.",
    checks: ["Satuan lokal", "Field kosong", "Original wording"],
    output: "Data koperasi terstruktur",
    status: "Aktif",
  },
  {
    name: "Agen Kualitas Komoditas",
    job: "Memberi rekomendasi grade awal dan daftar verifikasi manusia.",
    checks: ["Foto barang", "Kondisi", "Risiko kadar air"],
    output: "Rekomendasi grade awal",
    status: "Rules Lokal",
  },
  {
    name: "Agen Harga Wajar",
    job: "Menyusun rentang harga awal dengan alasan dan batasan.",
    checks: ["Grade", "Jumlah", "Risiko pasar"],
    output: "Range harga estimasi",
    status: "Rules Lokal",
  },
  {
    name: "Agen Pasar dan Mitra",
    job: "Mencari buyer atau mitra yang cocok tanpa menjanjikan penjualan.",
    checks: ["Kebutuhan buyer", "Jarak", "Match reason"],
    output: "Rekomendasi outreach",
    status: "Aktif",
  },
  {
    name: "Agen Unggulan Desa",
    job: "Menganalisis komoditas unggulan, aset desa, surplus, kekurangan, dan peluang usaha koperasi.",
    checks: ["Layer peta", "Supply signal", "Demand signal", "Aset pengolah", "Risiko logistik"],
    output: "Peluang usaha desa",
    status: "Aktif",
  },
  {
    name: "Agen Gerai dan Stok",
    job: "Mengecek stok gerai, restock, dan barang kritis.",
    checks: ["Stok minimum", "Supplier", "Permintaan warga"],
    output: "Saran restock",
    status: "Aktif",
  },
  {
    name: "Agen Simpan Pinjam Aman",
    job: "Membantu screening pembiayaan, bukan mengambil keputusan final.",
    checks: ["Tujuan pinjaman", "Kemampuan bayar", "Risiko non-predatory"],
    output: "Catatan untuk komite",
    status: "Simulasi Aman",
  },
  {
    name: "Agen Laporan",
    job: "Merangkum data untuk laporan, audit, dan export readiness.",
    checks: ["Data lengkap", "Evidence", "Field mapping"],
    output: "Ringkasan siap ekspor",
    status: "Aktif",
  },
];
...
export const waIntents = [
  {
    ...
    bot: "Baik Pak/Bu, saya catat rencana panen padi sekitar 5 kuintal di Blok C. Petugas koperasi akan bantu cek tanggal, berat, dan kualitas.",
    module: "Suara Warga",
  },
  {
    id: "cek-harga",
  ...
  },
  {
    ...
    bot: "Ada kandidat buyer: Nusantara Roastery. Match harus disetujui pengurus sebelum kontak dikirim.",
...
export const buyerMatches = [
  {
    ...
    match: "82",
    reason: "Kebutuhan buyer cocok dengan stok kopi kering setelah verifikasi grade.",
    status: "Perlu approval pengurus",
  },
  {
    buyer: "Dapur Olahan Desa",
    need: "Singkong segar",
    match: "76",
  ...
  {
    buyer: "Warung Mitra Kecamatan",
    need: "Beras medium",
    match: "69",
    reason: "Permintaan rutin kecil, cocok untuk suplai bertahap.",
    status: "Siap kontak",
  },
];
...
export const petaVillages = [
  {
    ...
    assets: [
      ...
      { id: "w-3", type: "umkm", name: "UMKM Dapur Olahan Desa", lat: -7.038, lng: 107.601, note: "Bisa rencana keripik", confidence: "Data awal" },
  ...
  },
  {
    ...
    assets: [
      ...
      { id: "t-5", type: "umkm", name: "Dapur Sambal Bu Sri", lat: -7.645, lng: 111.064, note: "Potensi olahan cabai", confidence: "Pilot" },
    ],
  },
  {
    code: "35.07.18.2004",
